"""
        NO ESTA TERMINADO, SI CARGA EL FONDO PERO NO MUEVE EL PERSONAJE
        =================================================================
...
def programa_principal():
    ...
    posicion_matrix_x, posicion_matrix_y = 7, 1
    razon_matriz = 50                                   # Tamaño de cada cuadro en píxeles
    pos_pixel_x, pos_pixel_y = 50, 50
    ...
    while not glfw.window_should_close(ventana):
        ...
        if glfw.get_key(ventana, glfw.KEY_RIGHT) == glfw.PRESS:
            ...
            pos_jugador_x += 0.01
            posicion_matrix_x -= 1  # ojo aqui esta el error
            direccion = "left"
            se_esta_moviendo = True
            indice_del_frame = (indice_del_frame + 1) % len(sprites[direccion])
        ...
        # pos_pixel_x = (posicion_matrix_x) * razon_matriz
        # pos_pixel_y = 450 - ((posicion_matrix_y + 1) * razon_matriz)
        # pos_pixel_x = 600 - ((posicion_matrix_x + 1) * razon_matriz)
        # pos_pixel_y = 450 - ((posicion_matrix_y + 1) * razon_matriz)
