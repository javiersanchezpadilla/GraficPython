...
def activa_el_foco():
    ...
    glLightfv(GL_LIGHT0, GL_POSITION, [0, 0, 15, 1])  # No [0,0,0,1]

    # # Y que los materiales tengan color
    glMaterialfv(GL_FRONT, GL_DIFFUSE, [1, 1, 0, 1])  # Rojo

    # # Opcional: para usar colores normales con glColor* (le asignamos su color a cada poligono)
